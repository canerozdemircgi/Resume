...
if (searchParams.has('matters'))
{
	...
	{
		span_job_requirements.insertAdjacentHTML('beforeend', `<text-entry-left br='15px' text='${matters[i]}' mark='_matter-black'></text-entry-left>`);
		span_my_qualifications.insertAdjacentHTML('beforeend', `<text-entry-right br='15px' text='${matters[i + 1]}' mark='_matter-black'></text-entry-right>`);
	}
}